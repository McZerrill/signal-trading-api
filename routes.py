    ...
    while True:
        ...
        for symbol in list(posizioni_attive.keys()):
            ...
            try:
                ...
                # Gap
                macd_gap_now = abs(macd_now - macd_signal_now)
                macd_gap_prev = abs(macd_prev - macd_signal_prev)
                ...
                if motivi:
                    simulazione_attiva["motivo"] = f"📉 Microtrend 1m inversione sostenuta: {motivi[0]}"
                    chiudere = True
                else:
