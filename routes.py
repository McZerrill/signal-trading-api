    ...
    while True:
        ...
        for symbol in list(posizioni_attive.keys()):
            ...
            try:
                ...
                # Condizioni inversione
                if tipo == "BUY":
                    if ema7 < ema25:
                        motivi.append("EMA↓")
                    if rsi_1m < 54.5:
                        motivi.append("RSI<54.5")
                    ...
                    if ema7 > ema25:
                        motivi.append("EMA↑")
                    if rsi_1m > 53:
                        motivi.append("RSI>53")
                    if macd_1m > macd_signal_1m + 0.001:
                        motivi.append("MACD↑")

                # Chiusura per inversione se almeno 2 segnali
                if len(motivi) >= 2:
                ...
                if tipo == "BUY":
                    if abs(ema7 - ema25) / ema25 < 0.0015:
                        vicini.append("EMA≈")
                    if 54 <= rsi_1m < 54.5:
                    ...
                    if abs(ema25 - ema7) / ema25 < 0.0015:
                        vicini.append("EMA≈")
                    if 53 < rsi_1m <= 54:
                        vicini.append(f"RSI={rsi_1m:.1f}")
